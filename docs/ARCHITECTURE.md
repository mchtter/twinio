...
14. **Katman bantları**: zone(0.04) < iç su(0.07) < alan(0.08) < patika(0.14) < tali yol(0.18) < ana yol(0.22) < kavşak plakası(0.26) < deniz(0.3) < kaldırım(0.30) < zebra(0.32); her bant kendi jitter payına sahiptir, bantlar kesişmez.
